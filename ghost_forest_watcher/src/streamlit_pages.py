"""
Streamlit page functions for Ghost Forest Watcher
Contains the implementation of different pages in the web application
"""
...
def show_map_page():
    ...
    with st.spinner("Loading map data..."):
        ...
        # Load SAM results with error handling
        try:
            sam_results = data_manager.run_sam_analysis()
        except Exception as e:
            st.warning(f"SAM analysis failed: {str(e)}")
            sam_results = None
...
- **Classification**: NDVI threshold-based health categorization
